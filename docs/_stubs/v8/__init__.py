...
_HostCallable: TypeAlias = Callable[..., object]
r"""
Python callable that can be exposed to JavaScript.
"""

_HostClassDecorator: TypeAlias = Callable[[_HostClassLike], _HostClassLike]
r"""
...
_HostFunctionDecorator: TypeAlias = Callable[[_HostCallable], _HostCallable]
r"""
...
_F = typing.TypeVar("_F", bound=Callable[..., object])
...
class Array:
    ...
    def __getitem__(self, index: int) -> Value:
        ...
        Read an array element.
        """
    def set(self, index: int, value: _JSValueLike) -> bool:
        r"""
        Set an array element.
        """
    def __setitem__(self, index: int, value: _JSValueLike) -> None:
        r"""
        Set an array element.
        """
...
class ArrayBuffer:
    ...
    def __len__(self) -> int:
        ...
        Return the byte length.
        """
    def typed_array(self, kind: str = 'Uint8Array', byte_offset: int = 0, length: int | None = None) -> TypedArray:
        r"""
        Create a TypedArray view over this ArrayBuffer.
        """
    def as_uint8_array(self, byte_offset: int = 0, length: int | None = None) -> TypedArray:
        r"""
        Create a Uint8Array view over this ArrayBuffer.
        """
    def data_view(self, byte_offset: int = 0, byte_length: int | None = None) -> DataView:
        r"""
...
class BaseProfile:
    ...
    def __new__(cls) -> BaseProfile:
        ...
        """
    @typing.overload
    def host_function(self, function: _F, *, name: str | None = None) -> _F:
        r"""
        ...
        """
    @typing.overload
    def host_function(self, function: None = None, *, name: str | None = None) -> Callable[[_F], _F]:
        r"""
        Register a Python callable as a JavaScript global function.
        ...
        callable's `__name__` is used as the JavaScript global name.
        """
    def host_function(self, function: _F | None = None, *, name: str | None = None) -> _F | Callable[[_F], _F]:
        r"""
        Register a Python callable as a JavaScript global function.
        ...
        """
    @typing.overload
    def class_(self, cls: _C, *, name: str | None = None) -> _C:
        r"""
        ...
        """
    @typing.overload
    def class_(self, cls: None = None, *, name: str | None = None) -> Callable[[_C], _C]:
        r"""
        Register a Python class as a JavaScript constructor template.
        ...
        on the Python class are exposed through V8 object templates.
        """
    def class_(self, cls: _C | None = None, *, name: str | None = None) -> _C | Callable[[_C], _C]:
        r"""
        Register a Python class as a JavaScript constructor template.
        ...
        on the Python class are exposed through V8 object templates.
        """
    def host_function_count(self) -> int:
        r"""
    ...
    def class_count(self) -> int:
        ...
        """
    def install(self, apis: Iterable[api.HostAPI]) -> BaseProfile:
        r"""
...
class Context:
    ...
    def low_memory_notification(self) -> None:
        ...
        """
    def memory_pressure(self, level: Literal['none', 'moderate', 'critical']) -> None:
        r"""
        Set V8's memory pressure level for this context's isolate.
        """
    def request_garbage_collection_for_testing(self, collection_type: Literal['full', 'minor'] = "full") -> None:
        r"""
        Request a V8 garbage collection cycle for testing.
        """
    def new_string(self, value: str) -> String:
        r"""
        Create a V8 string in this context.
        """
    def new_private(self, name: str | String | None = None, *, for_api: bool = False) -> Private:
        r"""
    ...
    def private_for_api(self, name: str | String | None = None) -> Private:
        ...
        """
    def new_object(self, internal_field_count: int = 0) -> Object:
        r"""
    ...
    def new_external(self, payload: object) -> External:
        ...
        """
    def compile_wasm_module(self, wire_bytes: bytes | bytearray | memoryview, cache: WasmModuleCache | None = None) -> WasmModule:
        r"""
    ...
    def from_python(self, value: _JSValueLike) -> Value:
        ...
        """
    def eval(self, source: str, timeout_ms: int | None = None) -> Value:
        r"""
        Compile and run JavaScript source immediately.
        """
    def set_global(self, name: str, value: _JSValueLike) -> bool:
        r"""
    ...
    def get_global(self, name: str) -> Value:
        ...
        """
    def parse_json(self, source: str) -> Value:
        r"""
    ...
    def perform_microtask_checkpoint(self) -> None:
        ...
        """
    def run_event_loop_once(self, timeout_ms: int | None = None) -> bool:
        r"""
    ...
    def run_until_idle(self, max_tasks: int | None = None) -> int:
        ...
        """
    def set_microtasks_policy(self, policy: str) -> None:
        r"""
    ...
    def terminate_execution(self) -> bool:
        ...
        """
    def cancel_terminate_execution(self) -> bool:
        r"""
        Cancel a pending termination request for JavaScript execution.
        """
    def compile_module(self, source: str, specifier: str = '<module>') -> Module:
        r"""
        Compile an ECMAScript module with the given specifier.
        """
    def compile_function(self, source: str | String, arguments: Sequence[str] | None = None, *, filename: str = '<function>', source_map_url: str | None = None, cached_data: bytes | bytearray | memoryview | None = None) -> Function:
        r"""
        Compile JavaScript source as a function object.
        """
    def compile(self, source: str | String, *, filename: str = '<script>', source_map_url: str | None = None, cached_data: bytes | bytearray | memoryview | None = None) -> Script:
        r"""
...
class ContextBuilder:
    ...
    def is_alive(self) -> bool:
        ...
        """
    def set_global(self, name: str, value: _JSValueLike) -> None:
        r"""
    ...
    def use_profile(self, profile: BaseProfile) -> None:
        ...
        """
    def use_snapshot(self, index: int = 0) -> None:
        r"""
...
class Function:
    ...
    def script_id(self) -> int:
        ...
        """
    @property
    def script_line_number(self) -> int | None:
        r"""
        Return the script line number for this function.
        """
    @property
    def script_column_number(self) -> int | None:
        r"""
    ...
    def resource_name(self) -> str | None:
        ...
        """
    @property
    def source_map_url(self) -> str | None:
        r"""
        Return the function's source map URL.
        """
    @property
    def cached_data_rejected(self) -> bool:
        r"""
...
class Inspector:
    ...
    def context_group_id(self) -> int:
        ...
        """
    def connect(self, state: str = '', *, trusted: bool = True, on_message: Callable[[str], object] | None = None) -> InspectorSession:
        r"""
...
class InspectorSession:
    ...
    def messages(self) -> list[str]:
        ...
        """
    @staticmethod
    def can_dispatch_method(method: str) -> bool:
        r"""
    ...
    def dispatch(self, message: str) -> None:
        ...
        """
    def schedule_pause_on_next_statement(self, reason: str, detail: str) -> None:
        r"""
...
class Isolate:
    ...
    def create_context(self) -> Context:
        ...
        """
    def create_context_from_snapshot(self, index: int = 0) -> Context:
        r"""
...
class JavaScriptError(RuntimeError):
    ...
    def message(self) -> str:
        ...
        """
    @property
    def message_info(self) -> Message | None:
        r"""
    ...
    def source_line(self) -> str | None:
        ...
        """
    @property
    def script_resource_name(self) -> str | None:
        r"""
    ...
    def end_position(self) -> int | None:
        ...
        """
    @property
    def wasm_function_index(self) -> int | None:
        r"""
    ...
    def error_level(self) -> int:
        ...
        """
    @property
    def is_shared_cross_origin(self) -> bool:
        r"""
    ...
    def stack(self) -> str | None:
        ...
        """
    @property
    def stack_trace(self) -> StackTrace | None:
        r"""
    ...
    def frames(self) -> list[StackFrame]:
        ...
        """
    def __new__(cls, message: str) -> JavaScriptError:
        r"""
...
class Map:
    ...
    def get(self, key: _JSValueLike) -> Value:
        ...
        """
    def set(self, key: _JSValueLike, value: _JSValueLike) -> bool:
        r"""
        Set a Map entry.
        """
    def has(self, key: _JSValueLike) -> bool:
        r"""
        Return whether the Map contains a key.
        """
    def delete(self, key: _JSValueLike) -> bool:
        r"""
        Delete a Map entry.
        """
    ...
    def __delitem__(self, key: _JSValueLike) -> None:
        ...
        Delete a Map entry.
        """
    def __contains__(self, key: _JSValueLike) -> bool:
        r"""
        Return whether the Map contains a key.
        """
...
class Module:
    ...
    def status(self) -> str:
        ...
        """
    def instantiate(self, imports: _ModuleImportsLike | None = None) -> bool:
        r"""
        Instantiate this module, optionally resolving imports from a dict.
        """
    def evaluate(self, timeout_ms: int | None = None) -> Value:
        r"""
...
class Object:
    ...
    """
    @property
    def internal_field_count(self) -> int:
        r"""
    ...
    def keys(self) -> list[object]:
        ...
        """
    def define_own_property(self, key: _JSPropertyNameLike, value: _JSValueLike, attributes: PropertyAttribute | None = None, *, read_only: bool = False, dont_enum: bool = False, dont_delete: bool = False) -> bool:
        r"""
        Define an own data property with optional V8 attributes.
        """
    def define_property(self, key: _JSPropertyNameLike, descriptor: PropertyDescriptor) -> bool:
        r"""
        Define a property using a full property descriptor.
        """
    def get_own_property_descriptor(self, key: _JSPropertyNameLike) -> PropertyDescriptor | None:
        r"""
    ...
    def get_property_attributes(self, key: _JSValueLike) -> PropertyAttribute:
        ...
        """
    def set_integrity_level(self, level: str) -> bool:
        r"""
    ...
    def get_private(self, key: Private) -> Value:
        ...
        """
    def set_private(self, key: Private, value: _JSValueLike) -> bool:
        r"""
        Set a private property.
        """
    def has_private(self, key: Private) -> bool:
        r"""
        Return whether a private property exists.
        """
    def delete_private(self, key: Private) -> bool:
        r"""
        Delete a private property.
        """
    def get_internal_field(self, index: int) -> Value | Private | None:
        r"""
        Return an internal field value.
        """
    def set_internal_field(self, index: int, data: object) -> bool:
        r"""
...
class Promise:
    ...
    def to_value(self) -> Value:
        ...
        """
    def __await__(self) -> Generator[object, None, Value]:
        r"""
...
class PropertyAttribute:
    ...
    def configurable(self) -> bool:
        ...
        """
    def __new__(cls, *, read_only: bool = False, dont_enum: bool = False, dont_delete: bool = False) -> PropertyAttribute:
        r"""
...
class PropertyDescriptor:
    ...
    def writable(self) -> bool | None:
        ...
        """
    @property
    def enumerable(self) -> bool | None:
        r"""
        Return the enumerable flag.
        """
    @property
    def configurable(self) -> bool | None:
        r"""
        Return the configurable flag.
        """
    def __new__(cls, value: _JSValueLike | None = None, *, get: _JSAccessorLike | None = None, set: _JSAccessorLike | None = None, writable: bool | None = None, enumerable: bool | None = None, configurable: bool | None = None) -> PropertyDescriptor:
        r"""
        Create a property descriptor.
        """
    @staticmethod
    def data(value: _JSValueLike, *, writable: bool | None = None, enumerable: bool | None = None, configurable: bool | None = None) -> PropertyDescriptor:
        r"""
        Create a data descriptor.
        """
    @staticmethod
    def accessor(*, get: _JSAccessorLike | None = None, set: _JSAccessorLike | None = None, enumerable: bool | None = None, configurable: bool | None = None) -> PropertyDescriptor:
        r"""
    ...
    def has_writable(self) -> bool:
        ...
        """
    def has_enumerable(self) -> bool:
        r"""
        Return whether this descriptor has an enumerable flag.
        """
    def has_configurable(self) -> bool:
        r"""
    ...
    def is_data_descriptor(self) -> bool:
        ...
        """
    def is_accessor_descriptor(self) -> bool:
        r"""
...
class RegExp:
    ...
    def to_value(self) -> Value:
        ...
        """
    def exec(self, subject: str) -> Object | None:
        r"""
...
class Script:
    ...
    def source_url(self) -> str | None:
        ...
        """
    @property
    def source_mapping_url(self) -> str | None:
        r"""
    ...
    def cached_data_rejected(self) -> bool:
        ...
        Return whether supplied cached data was rejected by V8.
        """
    def run(self, timeout_ms: int | None = None) -> Value:
        r"""
...
class Set:
    ...
    def clear(self) -> None:
        ...
        """
    def add(self, value: _JSValueLike) -> bool:
        r"""
        Add a value to the Set.
        """
    def has(self, value: _JSValueLike) -> bool:
        r"""
        Return whether the Set contains a value.
        """
    def delete(self, value: _JSValueLike) -> bool:
        r"""
        Delete a value from the Set.
        """
    def __contains__(self, value: _JSValueLike) -> bool:
        r"""
        Return whether the Set contains a value.
        """
    def values(self) -> list[Value]:
...
class SnapshotCreator:
    ...
    def is_alive(self) -> bool:
        ...
        """
    def eval(self, source: str, timeout_ms: int | None = None) -> None:
        r"""
        Execute JavaScript in the default snapshot context.
        """
    def add_context(self, source: str | None = None, *, timeout_ms: int | None = None) -> int:
        r"""
        Add a context snapshot and return its index.
        """
    def create_blob(self, function_code_handling: Literal['clear', 'keep'] = "clear") -> StartupData:
        r"""
...
class StackFrame:
    ...
    def script_name(self) -> str | None:
        ...
        """
    @property
    def script_name_or_source_url(self) -> str | None:
        r"""
        Return the script name or source URL.
        """
    @property
    def script_source(self) -> str | None:
        r"""
        Return the script source when V8 provides it.
        """
    @property
    def script_source_mapping_url(self) -> str | None:
        r"""
    ...
    def is_wasm(self) -> bool:
        ...
        """
    @property
    def is_user_javascript(self) -> bool:
        r"""
...
class Value:
    ...
    def is_array_buffer(self) -> bool:
        ...
        """
    def is_array_buffer_view(self) -> bool:
        r"""
    ...
    def to_string(self) -> str:
        ...
        """
    def strict_equals(self, other: Value) -> bool:
        r"""
        Compare this value with JavaScript strict equality.
        """
    def same_value(self, other: Value) -> bool:
        r"""
    ...
    def as_big_int(self) -> int | None:
        ...
        """
    def as_big_int_i64(self) -> int | None:
        r"""
        Return this BigInt as i64 when the conversion is lossless.
        """
    def as_big_int_string(self) -> str | None:
        r"""
    ...
    def as_function(self) -> dict[str, str] | None:
        ...
        """
    def as_v8_string(self) -> String | None:
        r"""
        Return this value as a String wrapper.
        """
    def as_v8_object(self) -> Object | None:
        r"""
        Return this value as an Object wrapper.
        """
    def as_v8_array(self) -> Array | None:
        r"""
        Return this value as an Array wrapper.
        """
    def as_v8_function(self) -> Function | None:
        r"""
        Return this value as a Function wrapper.
        """
    def as_v8_promise(self) -> Promise | None:
        r"""
        Return this value as a Promise wrapper.
        """
    def as_v8_map(self) -> Map | None:
        r"""
    ...
    def as_map(self) -> Map | None:
        ...
        Return this value as a Map wrapper.
        """
    def as_v8_set(self) -> Set | None:
        r"""
        Return this value as a Set wrapper.
        """
    def as_set(self) -> Set | None:
        r"""
        Return this value as a Set wrapper.
        """
    def as_v8_date(self) -> Date | None:
        r"""
    ...
    def as_date(self) -> Date | None:
        ...
        Return this value as a Date wrapper.
        """
    def as_v8_regexp(self) -> RegExp | None:
        r"""
        Return this value as a RegExp wrapper.
        """
    def as_regexp(self) -> RegExp | None:
        r"""
        Return this value as a RegExp wrapper.
        """
    def as_v8_proxy(self) -> Proxy | None:
        r"""
        Return this value as a Proxy wrapper.
        """
    def as_proxy(self) -> Proxy | None:
        r"""
        Return this value as a Proxy wrapper.
        """
    def as_v8_external(self) -> External | None:
        r"""
        Return this value as an External wrapper.
        """
    def as_external(self) -> External | None:
        r"""
        Return this value as an External wrapper.
        """
    def as_v8_wasm_module(self) -> WasmModule | None:
        r"""
        Return this value as a WasmModule wrapper.
        """
    def as_wasm_module(self) -> WasmModule | None:
        r"""
        Return this value as a WasmModule wrapper.
        """
    def as_v8_big_int(self) -> BigInt | None:
        r"""
        Return this value as a BigInt wrapper.
        """
    def as_v8_symbol(self) -> Symbol | None:
        r"""
        Return this value as a Symbol wrapper.
        """
    def as_v8_array_buffer(self) -> ArrayBuffer | None:
        r"""
        Return this value as an ArrayBuffer wrapper.
        """
    def as_v8_array_buffer_view(self) -> ArrayBufferView | None:
        r"""
        Return this value as an ArrayBufferView wrapper.
        """
    def as_v8_typed_array(self) -> TypedArray | None:
        r"""
        Return this value as a TypedArray wrapper.
        """
    def as_v8_data_view(self) -> DataView | None:
        r"""
    ...
    def get(self, key: _JSValueLike) -> Value:
        ...
        """
    def get_index(self, index: int) -> Value:
        r"""
    ...
    def set(self, key: _JSValueLike, value: _JSValueLike) -> bool:
        ...
        """
    def set_index(self, index: int, value: _JSValueLike) -> bool:
        r"""
    ...
    def __len__(self) -> int:
        ...
        """
    def instance_of(self, constructor: Value) -> bool:
        r"""
    ...
    def __rrshift__(self, other: _JSValueLike) -> Value:
        ...
        """
    def __eq__(self, other: _JSValueLike) -> bool:
        r"""
        Apply JavaScript loose equality.
        """
    def __ne__(self, other: _JSValueLike) -> bool:
        r"""
        Apply JavaScript loose inequality.
        """
    def __lt__(self, other: _JSValueLike) -> bool:
        r"""
        Apply JavaScript less-than comparison.
        """
    def __le__(self, other: _JSValueLike) -> bool:
        r"""
        Apply JavaScript less-than-or-equal comparison.
        """
    def __gt__(self, other: _JSValueLike) -> bool:
        r"""
        Apply JavaScript greater-than comparison.
        """
    def __ge__(self, other: _JSValueLike) -> bool:
        r"""
        Apply JavaScript greater-than-or-equal comparison.
        """
    def promise_state(self) -> str | None:
        r"""
        Return the promise state when this value is a Promise.
        """
    def promise_result(self) -> Value | None:
        r"""
...
class WasmModuleCache:
    ...
    def clear(self) -> None:
        ...
        """
    def contains(self, wire_bytes: bytes | bytearray | memoryview) -> bool:
        r"""
    ...
    def __bool__(self) -> bool:
        ...
        """
    def __contains__(self, wire_bytes: object) -> bool:
        r"""
